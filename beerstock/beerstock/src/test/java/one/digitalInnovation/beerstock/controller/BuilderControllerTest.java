...
{private static final String BEER_API_URL_PATH = "/api/v1/beers";
    ...
    void whenPOSTIsCalledThenABeerIsCreated() throws Exception {
        ...
        assert jsonPath("$.name", is(beerDTO.getName())) != null;
    ...
    private ResultMatcher jsonPath(String s, ElementMatcher.Junction<Object> objectJunction) {
        return null;
    }
    ...
    void whenGETListWithBeersIsCalledThenOkStatusIsReturned() throws Exception {
        ...
        when(beerService.listAll()).thenReturn((List<BeerDTO>) Collections.singletonList(beerDTO));
